...
//        when(auth.getName()).thenReturn("workify@example.com");
//        SecurityContextHolder.getContext().setAuthentication(auth);
//
//        when(boardRepository.findById(boardId)).thenReturn(Optional.of(board));
//        when(authRepository.findByEmail("workify@example.com")).thenReturn(Optional.of(authEntity));
...
//        verify(authRepository).findByEmail("workify@example.com");
